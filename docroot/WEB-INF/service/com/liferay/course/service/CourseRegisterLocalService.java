...
/**
 * Provides the local service interface for CourseRegister. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ces
 * @see CourseRegisterLocalServiceUtil
...
public interface CourseRegisterLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CourseRegisterLocalServiceUtil} to access the course register local service. Add custom service methods to {@link com.liferay.course.service.impl.CourseRegisterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
