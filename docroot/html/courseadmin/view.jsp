...
<aui:button-row cssClass="course-buttons">
	<portlet:renderURL var="addCourseURL">
		<portlet:param name="mvcPath" value="/html/courseadmin/edit_course.jsp"></portlet:param>
	</portlet:renderURL>
...
<liferay-ui:search-container>
	...
	>
		...
		<liferay-ui:search-container-column-jsp align="right" path="/html/courseadmin/course_actions.jsp" />
	</liferay-ui:search-container-row>
